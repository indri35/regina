        ...
        <!-- Horizontal Form -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><p class="fa fa-user-plus" style="font-size:26px">&#32;Add Distributor</p></h3>
            </div>
            <?php echo form_open_multipart('Admin/addnewdistributor');?>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="box-body">
                      ...
                      <div class="form-group form-horizontal">
                        ...
                        <div class="col-lg-9">
                          <input class=" form-control" name="distributor_code" type="text" placeholder="Distributor Code" required>
                      ...
                      <div class="form-group form-horizontal">
                        ...
                        <div class="col-lg-9">
                          <input class=" form-control" name="distributor_name" type="text" placeholder="Distributor Name" required><br/>
                        </div>
                      </div>
                      <div class="form-group form-horizontal">
                      ...
                      <div class="form-group">
                        <input  name="hak_akses" type="hidden" value="2" required>
                      </div>
