    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-5">
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <a href="<?= base_url() ?>Admin/goldupdate" class="btn btn-primary btn-block"><b>Update</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">List Order Gold Pack</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php 
                      $i = 1;
                      foreach($gold_order->result() as $row){ 
                  ?>
                <tr>
                  <td><center><?= $i ?></center></td>    
